...
* 03/26: I presented our work [Stochastic control for fine-tuning diffusion models]() at [INFORMS Optimization Society Conference](https://ios2026.isye.gatech.edu/) in Atlanta, Mar 20 - 22.
...
* 09/25: Our paper [Inexact Moreau Envelope Augmented Lagrangian Method for Nonconvex Robust Constrained Optimization](https://openreview.net/pdf?id=BVuORzJ4ye) is accepted by NeurIPS 2025 Workshop on Constrained Optimization for Machine Learning.
* 09/25: Our paper [Diffusion Models for Adapted Sequential Data Generation](https://openreview.net/pdf?id=2pfnuv913O) is accepted by NeurIPS 2025 Workshop MLxOR.
